...
- 🧩 Instance config: image and instance type as "dropdown + free input" controls (local built-in list merged with online lists, custom values allowed), plus billing method, system / data disks (type, size) and login auth.
