...
- 🧩 Instance config: image and instance type as editable dropdowns (local built-in list merged with online lists), plus billing method, system / data disks (type, size) and login auth.
